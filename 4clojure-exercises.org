...
- The [[https://clojure.org/reference/special_forms#fn][anonymous function special]] form can take a symbol name, which is can be used to reference the function recursively.
